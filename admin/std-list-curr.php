...
<html lang="zxx">
 ...
 date_default_timezone_set("Asia/Calcutta");  
 $ct=date('Y-m-d');
 $std="select l.regno as regno,l.intime as intime,l.out_time as out_time,s.name as name,s.year as year,s.semester as semester ,s.branch as branch from log l, students s where l.regno=s.reg_no and intime like '$ct%' and out_time='---'";
 $ct=date('d-m-Y');
 $res=mysqli_query($con,$std);
   if($res)
	   {
