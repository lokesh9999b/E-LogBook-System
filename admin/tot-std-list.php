...
<a href="totalstudents.php"><button class="nav-link active" >
 ...
 <tbody>
  ...
  date_default_timezone_set("Asia/Calcutta"); 
  $ct=date('Y-m-d');
   $q="select l.regno as regno,l.intime as intime,l.out_time as out_time,s.name as name,s.year as year,s.semester as semester ,s.branch as branch from log l,students s where l.regno=s.reg_no and  l.intime like '$ct%' order by l.intime desc";
